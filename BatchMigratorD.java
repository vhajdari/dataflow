...
public class BatchMigratorD {

    private static final int DEFAULT_BATCH_SIZE = 10000;
    private static final String CONFIG_FILE = "CONFIG_FILE_PATH"; // Environment variable name

    public static void main(String[] args) throws SQLException, ClassNotFoundException, IOException {
        // Get configuration file path from environment variable
        String configFilePath = Optional.ofNullable(System.getenv(CONFIG_FILE)).orElse("main.conf");
