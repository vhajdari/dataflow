...
public class BatchMigratorC {

    private static final int DEFAULT_BATCH_SIZE = 10000;
    private static final String CONFIG_FILE_PATH = "config.yml"; // Path to your YAML configuration file

    public static void main(String[] args) throws SQLException, ClassNotFoundException, IOException {
        // Load configuration from YAML file
        Map<String, Map<String, String>> connections = loadConnectionsFromYaml();
